    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub {{ Request::is('admin/santri*') ? 'active' : '' }}">
                    <a href="#" class='sidebar-link'>
                        <i class="fas fa-database"></i>
                        <span>Master Data</span>
                    </a>

                    <ul class="submenu {{ Request::is('admin/santri*') ? 'active submenu-open' : '' }}">
                        <li class="submenu-item {{ Request::is('admin/santri*') ? 'active' : '' }}">
